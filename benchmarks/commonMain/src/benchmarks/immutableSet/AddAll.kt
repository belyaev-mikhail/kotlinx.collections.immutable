...
open class AddAll {
    ...
    @Benchmark
    fun addAllDisjoint(): ImmutableSet<IntWrapper> {
        return set + setDisjoint
    }

    @Benchmark
    fun addAllMixed(): ImmutableSet<IntWrapper> {
        return set + setMixed
    }

    @Benchmark
    fun addAllCopy(): ImmutableSet<IntWrapper> {
        return set + setCopy
    }

    @Benchmark
    fun addAllDisjointOld(): ImmutableSet<IntWrapper> {
        return set.mutate { for(e in setDisjoint) it.add(e) }
    }

    @Benchmark
    fun addAllMixedOld(): ImmutableSet<IntWrapper> {
        return set.mutate { for(e in setMixed) it.add(e) }
    }

    @Benchmark
    fun addAllCopyOld(): ImmutableSet<IntWrapper> {
        return set.mutate { for(e in setCopy) it.add(e) }
    }
}