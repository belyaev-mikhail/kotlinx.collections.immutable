...
open class ContainsAll {
    ...
    @Benchmark
    fun containsAllDisjoint(): Boolean {
        return set.containsAll(setDisjoint)
    }

    @Benchmark
    fun containsAllMixed(): Boolean {
        return set.containsAll(setMixed)
    }

    @Benchmark
    fun containsAllCopy(): Boolean {
        return set.containsAll(setCopy)
    }

    @Benchmark
    fun containsAllDisjointOld(): Boolean {
        return setDisjoint.all { set.contains(it) }
    }

    @Benchmark
    fun containsAllMixedOld(): Boolean {
        return setMixed.all { set.contains(it) }
    }

    @Benchmark
    fun containsAllCopyOld(): Boolean {
        return setCopy.all { set.contains(it) }
    }
}