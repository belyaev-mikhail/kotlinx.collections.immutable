...
fun <E> altPersistentListOf(): PersistentList<E> = ImplicitKeyTreap.emptyOf<E>()
fun <E> altPersistentListOf(vararg elements: E): PersistentList<E> {
    var result: PersistentList<E> = altPersistentListOf<E>()
...
class AltImmutableListTest {
    ...
    @Test fun empty() {
        val empty1 = altPersistentListOf<Int>()
        val empty2 = altPersistentListOf<String>()
    ...
    @Test fun ofElements() {
        ...
        val list1 = altPersistentListOf("a", "d", 1, null)
        val list2 = altPersistentListOf("a", "d", 1, null)
    ...
    @Test fun addElements() {
        var list = altPersistentListOf<String>()
        list = list.add("x")
        list = list.add(0, "a")
    ...
    fun smallPersistentListFromMutableBuffer() {
        val list = List(33) { it }
        var vector = altPersistentListOf<Int>().mutate { it.addAll(list) }
    ...
    @Test fun builder() {
        val builder = altPersistentListOf<Char>().builder()
    ...
    @Test fun covariantTyping() {
        val listNothing = altPersistentListOf<Nothing>()
